...
try:
    ...
    raise ImportError(
        "lance-tensorflow requires TensorFlow. Install TensorFlow to use "
        "lance_tensorflow."
    ) from exc
...
def from_lance(
    ...
    *,
    ...
    .. code-block:: python
        ...
        ds = lance_tensorflow.from_lance(
            "s3://bucket/path",
            columns=["image", "id"],
    ...
    .. code-block:: python
        ...
        fragments = lance_tensorflow.lance_fragments("s3://bucket/path")
...
def register_tensorflow_dataset() -> None:
    """Register Lance convenience constructors on ``tf.data.Dataset``."""
